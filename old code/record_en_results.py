...
REVERSE_VOCABULARY_FILE = 'reverse_vocabulary.pkl'
COUNT_VECTORIZER_FILE = 'count_vectorizer.pkl'
TF_IDF_MATRIX_FILE = 'tf_idf_matrix.pkl'
WORD_VECTORS_FILE = 'results_en/word_vectors.pkl'
WORD_DISTANCES_FILE = 'results_en/word_distances.pkl'
SORTED_WORD_DISTANCES_FILE = 'results_en/sorted_word_distances.pkl'
